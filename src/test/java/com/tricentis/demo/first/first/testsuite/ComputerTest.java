...
import com.tricentis.demo.first.pages.ComputerPage;
...
public class ComputerTest extends BaseTest {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder(){
        ...
        boolean isSortedInDescendingOrder = computerPage.areProductsSortedDescending();
        Assert.assertTrue(isSortedInDescendingOrder,"Products are not properly displayed");
...
//        Assert.assertEquals(actualPriceTotal, expectedPriceTotal, "Wrong message display");
        ...
        computerPage.enterFirstName("Ella");

        //Enter the Last name
        computerPage.enterLastName("Patel");

        //Enter the email
        computerPage.enterEmail("EllaPatel@gamil.com");
        ...
        computerPage.enterCardholderName("Ella");
